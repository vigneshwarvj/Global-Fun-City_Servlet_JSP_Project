...
<head>
        ...
        <title>Privacy Policy - Global Fun City</title>

        <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/footer other pages css/privacypolicy.css">
...
<%-- <jsp:include page="<%=request.getContextPath() %>./footer/header_for_footer.jsp"></jsp:include> --%>
        ...
        <div class="background-color">
            ...
            <div class="privacy">
                <h1>Global Fun City Privacy Notice</h1>
            </div>
            ...
            <div class="notice">
                ...
                <h2>1. Who We Are</h2>
                <p>We are Global Fun City. That, preserving your privacy and safeguarding any information that you submit.
                    The following statement describes the general information-gathering and usage practices of our sites. Global Fun City always recognizes and values the privacy 
                    of individuals with whom we conduct business. However, in order to conduct global business in this increasingly electronic economy, the collection of personal information is often necessary and desirable. 
                    It is our goal to balance the benefits with the right of individuals to prevent the misuse of their personal information.
                ...
                <p>Preserving your privacy and safeguarding any information that you submit. The following statement describes the general information-gathering and usage practices of our sites. e-o-d Adventure Park always recognizes and values the privacy of individuals with whom we conduct business. However, in order to conduct global business in this increasingly electronic economy, the collection of personal information is often necessary and desirable. It is our goal to balance the benefits with the right of individuals to prevent the misuse of their personal information.</p>
                ...
                <h2>4. Cookies</h2>
                <p>This site uses cookies – small text files that are placed on your machine to help the site provide a better user experience. In general, cookies are used to retain user preferences, store information for things like shopping carts, and provide anonymised tracking data to third party applications like Google Analytics. Cookies generally exist to make your browsing experience better. However, you may prefer to disable cookies on this site and on others. The most effective way to do this is to disable cookies in your browser. </p>

                <h2>5. Who Has Access To Your Data</h2>
                <p>If you are not a registered client for our site, there is no personal information we can retain or view regarding yourself.
                ...
                <p>We don’t share your data with third-parties in a way as to reveal any of your personal information like email, name, etc. The only exceptions to that rule are for partners we have to share limited data with in order to provide the services you expect from us.</p>
                ...
                <p>We use the SSL/HTTPS protocol throughout our site. This encrypts our user communications with the servers so that personally identifiable information is not captured/hijacked by third parties without authorization.

                    In case of a data breach, system administrators will immediately take all needed steps to ensure system integrity, will contact affected users and will attempt to reset passwords if needed.</p>
